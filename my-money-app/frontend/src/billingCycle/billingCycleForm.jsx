...
class BillingCyclyForm extends Component {
...
BillingCyclyForm = reduxForm({form: 'billingCycleForm', destroyOnUnmount: false})(BillingCyclyForm)
...
export default connect(mapStateToProps, mapDispatchToProps)(BillingCyclyForm)